...
public class NHS : RibbonForm
{
  ...
  private void OnAccuLinkInformationClick(object sender, ItemClickEventArgs e)
  {
    ...
    stringBuilder.AppendFormat("AccuLink {0}{1}", (object) Application.ProductVersion, (object) Environment.NewLine);
    ...
    stringBuilder.AppendFormat("Log File: {0}{1}", (object) SystemConfigurationManager.Instance.ApplicationLogFile, (object) Environment.NewLine);
    ...
    int num = (int) UserInterfaceManager.Instance.ShowMessageBox(stringBuilder.ToString(), "AccuLink System Information", AnswerOptionType.OK, QuestionIcon.Information);
  }
