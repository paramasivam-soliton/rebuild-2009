...
// Type: PathMedical.AudiologyTest.DataAccessLayer.OverallTestInformationAdapter
...
public class OverallTestInformationAdapter(DBScope scope) : AdapterBase<OverallTestInformation>(scope)
{
}
