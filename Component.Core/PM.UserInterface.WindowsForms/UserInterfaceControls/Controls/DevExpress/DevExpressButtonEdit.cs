...
// Type: PathMedical.UserInterface.WindowsForms.UserInterfaceControls.Controls.DevExpress.DevExpressButtonEdit
...
public class DevExpressButtonEdit : ButtonEdit, ISupportUndo, IValidatableControl, IControl
{
  protected DXValidationProvider ValidationProvider = new DXValidationProvider();
  protected PathMedical.UserInterface.WindowsForms.UserInterfaceControls.Controls.DevExpress.ControlModificationHelper<DevExpressButtonEdit> ControlModificationHelper;
  ...
  public DevExpressButtonEdit()
  {
    this.ControlModificationHelper = new PathMedical.UserInterface.WindowsForms.UserInterfaceControls.Controls.DevExpress.ControlModificationHelper<DevExpressButtonEdit>(this);
  ...
  public override string ToString() => $"DevExpressButtonEdit {this.Name} [{this.Text}]";
