...
// Type: PathMedical.UserInterface.WindowsForms.UserInterfaceControls.Controls.DevExpress.DevExpressDateEdit
...
public class DevExpressDateEdit : DateEdit, IControl, ISupportUndo, IValidatableControl
{
  private readonly DXValidationProvider validationProvider = new DXValidationProvider();
  protected ControlModificationHelper<DevExpressDateEdit> controlModificationHelper;
  ...
  public DevExpressDateEdit()
  {
    this.controlModificationHelper = new ControlModificationHelper<DevExpressDateEdit>(this);
  ...
  public override string ToString() => $"DevExpressDateEdit {this.Name} [{this.Text}]";
