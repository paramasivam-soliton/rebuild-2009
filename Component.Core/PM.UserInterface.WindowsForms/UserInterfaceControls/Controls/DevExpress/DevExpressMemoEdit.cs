...
// Type: PathMedical.UserInterface.WindowsForms.UserInterfaceControls.Controls.DevExpress.DevExpressMemoEdit
...
public class DevExpressMemoEdit : MemoEdit, ISupportUndo, IValidatableControl, IControl
{
  private DXValidationProvider validationProvider = new DXValidationProvider();
  protected ControlModificationHelper<DevExpressMemoEdit> controlModificationHelper;
  private bool isMandatory;
  private bool isModified;
  private Color? defaultBackColor;
  private Color? borderColor = new Color?(Color.LightGray);

  public DevExpressMemoEdit()
  {
    this.controlModificationHelper = new ControlModificationHelper<DevExpressMemoEdit>(this);
  ...
  public object Value
  {
    ...
    set
    {
      try
      {
        ...
        this.EditValue = value ?? (object) string.Empty;
        this.SetSaved();
      }
      finally
      {
  ...
  public override string ToString() => $"DevExpressMemoEdit {this.Name} [{this.Text}]";
