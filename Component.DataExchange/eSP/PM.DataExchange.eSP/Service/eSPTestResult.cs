...
// Type: PathMedical.DataExchange.eSP.Service.EspTestResults
...
[XmlRoot(ElementName = "eSPTestResults", IsNullable = true)]
[Serializable]
public class EspTestResults
{
  [XmlElement("eSPTestResult")]
  public EspTestResultType[] EspTestResult { get; set; }
}
