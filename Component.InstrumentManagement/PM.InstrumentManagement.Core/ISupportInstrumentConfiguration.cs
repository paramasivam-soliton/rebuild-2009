...
// Type: PathMedical.InstrumentManagement.ISupportInstrumentConfiguration
...
public interface ISupportInstrumentConfiguration
{
  void ConfigureInstrument(IInstrument instrument);
}
