...
// Type: PathMedical.InstrumentManagement.ISupportInstrumentDataDownload
...
public interface ISupportInstrumentDataDownload
{
  void DownloadInstrumentData(IInstrument instrument);
}
