...
// Type: PathMedical.InstrumentManagement.ISupportInstrumentDataUpload
...
public interface ISupportInstrumentDataUpload
{
  void UploadInstrumentData(IInstrument instrument);
}
