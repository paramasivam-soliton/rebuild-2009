...
// Type: PathMedical.InstrumentManagement.ISupportInstrumentFirmwareUpdate
...
public interface ISupportInstrumentFirmwareUpdate
{
  void UpdateFirmware(IInstrument instrument, byte[] image);
}
