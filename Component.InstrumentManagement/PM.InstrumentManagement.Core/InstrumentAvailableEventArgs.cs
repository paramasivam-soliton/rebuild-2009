...
// Type: PathMedical.InstrumentManagement.InstrumentAvailableEventArgs
...
public class InstrumentAvailableEventArgs : EventArgs
{
  public IInstrument Instrument { get; protected set; }

  public InstrumentAvailableEventArgs(IInstrument instrument) => this.Instrument = instrument;
}
