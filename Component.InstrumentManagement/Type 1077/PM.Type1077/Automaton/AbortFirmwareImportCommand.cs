...
// Type: PathMedical.Type1077.Automaton.AbortFirmwareImportCommand
...
[CLSCompliant(false)]
public class AbortFirmwareImportCommand : CommandBase
{
  private readonly FirmwareManager firmwareManager;

  public AbortFirmwareImportCommand(FirmwareManager firmwareManager)
  {
  ...
  public override void Execute()
  {
    if (this.firmwareManager == null)
      return;
    this.firmwareManager.CancelImport();
  }
}
