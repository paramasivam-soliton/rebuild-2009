...
// Type: PathMedical.Type1077.Automaton.StartSearchInstrumentsCommand
...
[CLSCompliant(false)]
public class StartSearchInstrumentsCommand : CommandBase
{
  private readonly Type1077Manager instrumentDataManager;

  public StartSearchInstrumentsCommand(Type1077Manager model)
  {
    if (model == null)
      throw ExceptionFactory.Instance.CreateException<ArgumentNullException>(nameof (model));
    this.Name = nameof (StartSearchInstrumentsCommand);
    this.instrumentDataManager = model;
  }

  public override void Execute()
  {
    if (this.instrumentDataManager == null)
      return;
    this.instrumentDataManager.SearchInstruments();
  }
}
