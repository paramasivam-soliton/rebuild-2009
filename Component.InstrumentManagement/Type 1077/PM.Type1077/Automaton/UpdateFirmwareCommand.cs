...
// Type: PathMedical.Type1077.Automaton.UpdateFirmwareCommand
...
[CLSCompliant(false)]
public class UpdateFirmwareCommand : CommandBase
{
  private readonly Type1077Manager instrumentDataManager;

  public UpdateFirmwareCommand(Type1077Manager instrumentDataManager)
  {
  ...
  public override void Execute()
  {
    if (this.instrumentDataManager == null || this.TriggerEventArgs == null || !(this.TriggerEventArgs.TriggerContext is IntrumentSelectionTriggerContext))
      return;
    this.instrumentDataManager.UpdateFirmware((IInstrument) ((IntrumentSelectionTriggerContext) this.TriggerEventArgs.TriggerContext).Instrument);
  }
}
