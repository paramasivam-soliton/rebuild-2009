...
// Type: PathMedical.PatientManagement.Command.PasteTestCommand
...
public class PasteTestCommand : CommandBase
{
  private readonly PatientManager model;
  private object audiologyTest;

  public PasteTestCommand(PatientManager model)
  {
    if (model == null)
      throw ExceptionFactory.Instance.CreateException<ArgumentNullException>(nameof (model));
    this.Name = nameof (PasteTestCommand);
    this.model = model;
  }

  public override void Execute()
  {
    this.model.AssignCopiedTestToNewPatient(this.model.SelectedPatient, this.model.TestToCopy);
  }
}
