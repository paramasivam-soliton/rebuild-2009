...
// Type: PathMedical.PatientManagement.DataAccessLayer.PredefinedCommentAssociationAdapter
...
public class PredefinedCommentAssociationAdapter(DBScope scope) : 
  AdapterBase<PredefinedCommentAssociation>(scope)
{
}
