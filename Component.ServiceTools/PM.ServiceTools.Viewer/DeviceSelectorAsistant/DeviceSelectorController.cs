...
// Type: PathMedical.ServiceTools.WindowsForms.DeviceSelectorAsistant.DeviceSelectorController
...
public class DeviceSelectorController : Controller<Type1077Manager, DeviceSelectorAssistant>
{
    ...
    : base(applicationComponentModule)
  {
    ...
    this.View = new DeviceSelectorAssistant((IModel) this.Model);
