...
// Type: PathMedical.ServiceTools.WindowsForms.FirmwareUploadAssistant.FirmwareUploadAssistantController
...
internal class FirmwareUploadAssistantController : 
  Controller<Type1077Manager, PathMedical.ServiceTools.WindowsForms.FirmwareUploadAssistant.FirmwareUploadAssistant>
{
  public FirmwareUploadAssistantController(
    IApplicationComponentModule applicationComponentModule)
    : base(applicationComponentModule)
  {
    this.Model = Type1077Manager.Instance;
    this.View = new PathMedical.ServiceTools.WindowsForms.FirmwareUploadAssistant.FirmwareUploadAssistant((IModel) this.Model);
  ...
  private void SetupStateMachine()
  {
    ...
    new TransitionDefinition().AddFromTo(States.Viewing).AddFromTo(States.Editing).SetTrigger(ServiceToolsTriggers.UploadFirmwareFileTrigger).SetCommand((ICommand) new UploadFirmwareFileCommand(this.Model)).ApplyTo(this.StateMachine);
