...
// Type: PathMedical.ServiceTools.Automaton.GetMicrofoneRmsTriggerContext
...
[CLSCompliant(false)]
public class GetMicrofoneRmsTriggerContext : TriggerContext
{
  public int Microfone { get; protected set; }

  public Type1077Instrument Instrument { get; protected set; }

  public GetMicrofoneRmsTriggerContext(Type1077Instrument instrument)
  {
