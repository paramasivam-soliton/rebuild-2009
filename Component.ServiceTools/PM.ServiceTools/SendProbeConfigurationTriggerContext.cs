...
// Type: PathMedical.ServiceTools.Automaton.SendProbeConfigurationTriggerContext
...
public class SendProbeConfigurationTriggerContext : TriggerContext
{
  public Instrument Instrument { get; protected set; }

  public Type1077ProbeInformation Probe { get; protected set; }

  public SendProbeConfigurationTriggerContext(Instrument instrument, Type1077ProbeInformation probe)
  {
