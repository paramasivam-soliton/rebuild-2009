...
// Type: PathMedical.SiteAndFacilityManagement.DataAccessLayer.LocationTypeAdapter
...
#nullable disable
namespace PathMedical.SiteAndFacilityManagement.DataAccessLayer;

public class LocationTypeAdapter(DBScope scope) : AdapterBase<LocationType>(scope)
{
}
