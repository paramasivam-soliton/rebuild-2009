...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer
...
public sealed class ArrayOfObjectSerializer : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("downloadSyncData", "http://www.myapp.org");
  }

  protected override void Serialize(object objectToSerialize, XmlSerializationWriter writer)
  {
    ((XmlSerializationWriterDataUpload) writer).Write7_downloadSyncData((object[]) objectToSerialize);
  }
}
