...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer1
...
public sealed class ArrayOfObjectSerializer1 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("downloadSyncDataResponse", "http://www.myapp.org");
  }

  protected override object Deserialize(XmlSerializationReader reader)
  {
    return (object) ((XmlSerializationReaderDataUpload) reader).Read7_downloadSyncDataResponse();
  }
}
