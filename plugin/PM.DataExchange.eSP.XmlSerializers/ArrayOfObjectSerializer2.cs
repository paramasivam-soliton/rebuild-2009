...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer2
...
public sealed class ArrayOfObjectSerializer2 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("downloadSyncDataInHeaders", "http://www.myapp.org");
  }

  protected override void Serialize(object objectToSerialize, XmlSerializationWriter writer)
  {
    ((XmlSerializationWriterDataUpload) writer).Write8_downloadSyncDataInHeaders((object[]) objectToSerialize);
  }
}
