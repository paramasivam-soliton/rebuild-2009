...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer4
...
public sealed class ArrayOfObjectSerializer4 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("uploadData", "http://www.myapp.org");
  }

  protected override void Serialize(object objectToSerialize, XmlSerializationWriter writer)
  {
    ((XmlSerializationWriterDataUpload) writer).Write9_uploadData((object[]) objectToSerialize);
  }
}
