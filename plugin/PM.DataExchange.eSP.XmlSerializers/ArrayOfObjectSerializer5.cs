...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer5
...
public sealed class ArrayOfObjectSerializer5 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("uploadDataResponse", "http://www.myapp.org");
  }

  protected override object Deserialize(XmlSerializationReader reader)
  {
    return (object) ((XmlSerializationReaderDataUpload) reader).Read9_uploadDataResponse();
  }
}
