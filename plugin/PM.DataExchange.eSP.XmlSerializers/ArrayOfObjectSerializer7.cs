...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer7
...
public sealed class ArrayOfObjectSerializer7 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("uploadDataResponseOutHeaders", "http://www.myapp.org");
  }

  protected override object Deserialize(XmlSerializationReader reader)
  {
    return (object) ((XmlSerializationReaderDataUpload) reader).Read10_uploadDataResponseOutHeaders();
  }
}
