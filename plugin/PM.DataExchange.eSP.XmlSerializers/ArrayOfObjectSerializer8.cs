...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer8
...
public sealed class ArrayOfObjectSerializer8 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("validateEquipment", "http://www.myapp.org");
  }

  protected override void Serialize(object objectToSerialize, XmlSerializationWriter writer)
  {
    ((XmlSerializationWriterDataUpload) writer).Write11_validateEquipment((object[]) objectToSerialize);
  }
}
