...
// Type: Microsoft.Xml.Serialization.GeneratedAssembly.ArrayOfObjectSerializer9
...
public sealed class ArrayOfObjectSerializer9 : XmlSerializer1
{
  ...
  {
    return xmlReader.IsStartElement("validateEquipmentResponse", "http://www.myapp.org");
  }

  protected override object Deserialize(XmlSerializationReader reader)
  {
    return (object) ((XmlSerializationReaderDataUpload) reader).Read11_validateEquipmentResponse();
  }
}
